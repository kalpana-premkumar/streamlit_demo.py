...
#model.load_weights (https://drive.google.com/file/d/1pKM4-pCayQyKDLhAgJ4E2Xxv1T1g8m6V/view?usp=share_link)
...
st.set_page_config(page_title="OCR App", page_icon=":pencil2:")

# Define the navigation menu
menu = ["Image to Text Converter", "Word Text Recognition Model"]
